...
const SupportPage = () => {
    return (
        <div>
            ...
            <Row className="my-4">
                <Col className='col1'>
                    <Image style={{ width: '1500px', height: "350px" }} src="https://img.freepik.com/free-photo/abstract-textured-backgound_1258-30621.jpg" fluid />
                </Col>
            </Row>
            <Row className="my-4">
                <Col>
                    <div className='new8'>
                        ...
                        <FormControl className='new9' type="text" placeholder="TYPE YOUR QUESTION HERE" />
                    </div>
                </Col>
  ...
  <Link className="nav-link" to="/self-drive">
    <div className="icon-text">
      <FontAwesomeIcon icon={faCar} />
      <span>Self Drive</span>
    </div>
  </Link>
  <Link className="nav-link" to="/ecash">
    <div className="icon-text">
  ...
  <Link className="nav-link" to="/trains">
    <div className="icon-text">
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header>How can I reschedule my flight booking?</Accordion.Header>
        <Accordion.Body>
          <small>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header>How to check/claim refund on my booking?</Accordion.Header>
        <Accordion.Body>
        <small>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
    ...
    <Accordion defaultActiveKey="0" flush>
      <Accordion.Item eventKey="1">
        <Accordion.Header>How do I print my e-ticket?</Accordion.Header>
        <Accordion.Body>
        <small></small>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header>How do I login to My Bookings section on Yatra.com?</Accordion.Header>
        <Accordion.Body>
        <small>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
        ...
        <Accordion.Item eventKey="1">
        <Accordion.Header>Do I get any refund if I cancel my ticket?</Accordion.Header>
    ...
    <footer  className='FOOTR' style={{ backgroundColor: '#f8f9fa', padding: '20px', marginTop: '20px' }}>
      <Row>
